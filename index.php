  ...
  <section id="home" class="topContent">
    <div class="mainHeading">
      ...
      <div class="intro-text">
            <h4>A Basic Banking System for making transactions between users</h4>
						<p>
    ...
    <div class="topContentImg">
      <img src="images/banking_homepages.jpg" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/abouts.jpg" alt="TSF Bank">
        </div>
        <div class="col-md-6 mx-auto mt-4">
          <div>
            <h3>Bank of Ankita</h3>
          </div>
          <div class="mt-2">
            <span class="sub-content">It is a Basic Banking System for making transactions between users.
              ...
              <P> Basic banking services include a payment account with basic features and an instrument for
               using the account (e.g. a debit card and online banking ID), the possibility to withdraw cash,
                the execution of payment transactions and an electronic means of identification.</P>
                <h5>
                  "Your bank account can be overdrawn, but it can never be overfilled."</h5>
          </div>
    ...
    <div class="container  text-center">
      <div class="row">
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/customer.jpg" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/transaction.jpg" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/transfers.jpg" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
  ...
  <footer>
    <div class="follow">
      ...
      <div class="social">
        ...
        <a href="https://www.linkedin.com/in/ankita-mishra-a3595517a/" class="linkedin">
          <i class="fa fa-linkedin"></i>
        </a>
        <a href="https://www.instagram.com/ankita_7779/" class="instagram">
          <i class="fa fa-instagram"></i>
        </a>
      </div>
    </div>
    <p class="text-copy">
      Copyright &copy; 2021 , Developed By :- Ankita Mishra
    </p>
  </footer>
  <!-- End Footer -->
